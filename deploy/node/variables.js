...
module.exports = {
  ...
  APP_NAME: process.env.APP_NAME || 'ml-api-adapter',
  AWS_REGION: process.env.AWS_REGION || 'us-west-2',
  ENVIRONMENT: environment,
  VERSION: process.env.CIRCLE_TAG || process.env.CIRCLE_BRANCH + '-' + process.env.CIRCLE_BUILD_NUM,
  API: {
    NAME: 'ml-api-adapter',
    IMAGE: process.env.API_IMAGE || 'leveloneproject/ml-api-adapter',
    PORT: process.env.API_PORT || 3000
  },
  ADMIN: {
    NAME: 'ml-api-adapter-admin',
    IMAGE: process.env.ADMIN_IMAGE || 'leveloneproject/ml-api-adapter-admin',
  ...
  HOSTNAME: process.env.HOSTNAME || 'http://ml-api-adapter-TEST-1778278640.us-west-2.elb.amazonaws.com',
