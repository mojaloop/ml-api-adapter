...
const config = {
  ...
  HTTP_CLIENT: {
    MAX_SOCKETS: RC.HTTP_CLIENT?.MAX_SOCKETS || 256,
    MAX_FREE_SOCKETS: RC.HTTP_CLIENT?.MAX_FREE_SOCKETS || 256,
    SOCKET_TIMEOUT_MS: RC.HTTP_CLIENT?.SOCKET_TIMEOUT_MS || 60000
  },
